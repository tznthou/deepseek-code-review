...
2026-09-19／20 以真實 API 跑過 12 次、5 個真實歷史 commit 當標的，整套花費 **$0.08**：
...
12 次真實 API 呼叫、5 個真實歷史 commit 當標的。模型講的每一句話都另外驗證過——
...
* **`deepseek_review.py` 對真實 DeepSeek API 端到端跑通**（2026-09-19／20，12 次呼叫、
  5 個真實歷史 commit 當標的，總花費 $0.08）。這條在 2026-09-17 的版本裡還是「未驗證」——
